...
/// <item>If you keep a reference to a poolable object you must check if the object was already moved back to the pool or even re-used again. 
/// Use <see cref="PoolableReference{T}"/> for this.</item>
/// </list>
/// </example>
    ...
    internal class ObjectPool
    {
        ...
        private void _ValidatePooledObjectDataContainer()
        {
            if ( _pool == null )
            {
                ...
                poolParentDummy = poolParentDummyGameObject.transform;
